...
L["Allow for moving of the minimap and surrounding frames"] = "Permite mover el minimapa y los iconos en su alrededor." -- Needs review
L["Allow the coordinate indicator to be moved"] = "Permite que el indicador de coordenadas sea movido" -- Needs review
L["Allow the location indicator to be moved"] = "Permite que el indicador de lugar sea movido" -- Needs review
L["Allow the minimap to be movable so you can drag it where you want"] = "Permite arrastar y soltar el minimapa en cualquier parte de la pantalla" -- Needs review
L["Allow the ping indicator to be moved"] = "Permite que el indicador de ping sea movido" -- Needs review
L["Angle"] = "Angulo" -- Needs review
L["Angle on the minimap"] = "Angulo en el minimapa" -- Needs review
...
L["Border radius"] = "Radio del borde" -- Needs review
L["Border style"] = "Estilo del borde" -- Needs review
-- L["Boss frames"] = ""
L["Bottom"] = "Fondo" -- Needs review
L["Bottom-left"] = "Fonde a la izquierda" -- Needs review
L["Bottom-right"] = "Fondo a la derecha" -- Needs review
L["Button border opacity"] = "Opacidad del borde del botón" -- Needs review
L[ [=[Button to use on the minimap to open the preferences window.
Note: you can always open with /chin]=] ] = "Botón a usar en el minimapa para abrir las preferencias. Nota: Podrás abrirlas directamente con /chin" -- Needs review
...
L["Color of the circle"] = "Color del círculo" -- Needs review
L["Color of the indicators"] = "Color del indicador" -- Needs review
L["Combat opacity"] = "Opacidad en combate" -- Needs review
-- L["Compass"] = ""
L["Completed daily quest"] = "Misiones diarias completadas" -- Needs review
-- L["Completed quest"] = ""
-- L["Coordinates"] = ""
