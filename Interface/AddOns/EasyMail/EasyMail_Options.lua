...
function EasyMail.OptionsRefresh(self)
	...
	EasyMail_OptionsPanelAttReport:SetChecked(EasyMail_SavedVars.AttReport == "Y");
...
function EasyMail.OptionsOkay()
	...
	EasyMail_SavedVars.AttReport = ((EasyMail_OptionsPanelAttReport:GetChecked() and "Y") or "N");
